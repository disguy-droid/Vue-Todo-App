...
<template>
  <div id="container" class="bg-light min-h-screen select-none">
    <div class="h-56 flex flex-col justify-center items-center space-y-8">
      <svg
        class="w-14 h-14 text-dark/60"
        viewBox="0 0 24 24"
        fill="none"
      ...
      <h1 class="font-sourceCodePro text-5xl font-extrabold text-dark">
        Todo App
      </h1>
    </div>
    <Todo />
